defmodule Selenium.Commands.Mouse do
  ...
  def move_to(identifier, position, element \\ nil) do
    ...
    {:ok, %HTTPoison.Response{body: body,
                              headers: _,
                              status_code: _}} = Request.post("session/#{session_id}/moveto", %{"xoffset" => position.x, "yoffset" => position.y, "element" => element}, [recv_timeout: :infinity])
    body["value"]
  end
  ...
  def click(identifier, button) do
    ...
    {:ok, %HTTPoison.Response{body: body,
                              headers: _,
                              status_code: _}} = Request.post("session/#{session_id}/click", %{"button" => @mouse_button[button]}, [recv_timeout: :infinity])
    body["value"]
  end
  ...
  def button_down(identifier, button) do
    ...
    {:ok, %HTTPoison.Response{body: body,
                              headers: _,
                              status_code: _}} = Request.post("session/#{session_id}/buttondown", %{"button" => @mouse_button[button]}, [recv_timeout: :infinity])
    body["value"]
  end
  ...
  def button_up(identifier, button) do
    ...
    {:ok, %HTTPoison.Response{body: body,
                              headers: _,
                              status_code: _}} = Request.post("session/#{session_id}/buttonup", %{"button" => @mouse_button[button]}, [recv_timeout: :infinity])
    body["value"]
  end
  ...
  def double_click(identifier, button) do
    ...
    {:ok, %HTTPoison.Response{body: body,
                              headers: _,
                              status_code: _}} = Request.post("session/#{session_id}/doubleclick", %{"button" => @mouse_button[button]}, [recv_timeout: :infinity])
    body["value"]
  end
end
